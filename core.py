...
from microsoft_graph.mail import fetch_message, parse_body, parse_form_submission, split_display_name
...
def process_notification(token: str, message_id: str) -> None:
    ...
    if is_form:
        ...
        if parsed:
            ...
            logger.warning("Form submission body could not be parsed for message %s — falling back to envelope sender.", message_id)
